...
- Standard and attachment-research answers create owner-scoped Markdown artifacts with revision numbers, optimistic conflict detection, download support, and a live side-panel editor.
