...
function Agents() {
  ...
  return (
    <div><p className="eyebrow">Specialist network</p><h1 className="page-title">Agent roster <span className="text-indigo-200">({agents.length})</span></h1><p className="page-subtitle mb-8">Find the right expertise across your active collaborators.</p>{state === 'loading' ? <LoadingState label="Syncing the agent roster…" /> : state === 'error' ? <ErrorState message="The agent roster is temporarily unavailable." onRetry={loadAgents} /> : <>
      ...
      {state === 'ready' && <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
